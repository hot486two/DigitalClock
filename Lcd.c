...
{		
	...
	*/
	rVIDCON0= (0x0<<22)+(0x1<<13)+((CLKVAL)<<6)+(1<<5)+(1<<4)+(0<<2);	// (0x0<<22)+(0x1<<13)+((CLKVAL)<<6)+(1<<5)+(1<<4)+(0<<2)
	rVIDCON1= (1<<6)+(1<<5);	// (1<<6)+(1<<5)
	...
	*/
	rWINCON0=(0x1<<16)+(0x7<<2)+(1<<0); //(0x1<<16)+(0x7<<2)+(1<<0)
...
void NonPal_Put_Pixel(int x, int y, int color)
{
	...
	NonPal_Fb[y][x] = (unsigned short int)color;	// color
